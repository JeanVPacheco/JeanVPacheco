...
## Back-end
- [Store Manager](https://github.com/JeanVPacheco/sd-013-c-store-manager) - Estudo das camadas de Model, Service, Controller e desenvolvimento de uma API nos padrões REST
